...
const articles = [
  ...
  },
  {
    ...
    readingTime: 12,
    url: 'ecuador-hedge-payoffs.html',
    title:   "Four Structures, One Problem: The Payoff Mathematics of Ecuador's Sovereign Oil Hedge",
    excerpt: "Why the choice between an Asian put, a collar, and a three-way collar is not a matter of preference — it is a matter of what each structure does to Ecuador's fiscal revenue distribution under dollarization constraints.",
  },
  {
    id: 12,
  ...
  {
    id: 11,
    slug: 'ai-infrastructure-utility-regulation',
    featured: false,
    category: 'ai',
    catClass: 'cat-ai',
    date: '2026-03-31',
    ...
    readingTime: 12,
    url: 'article-ai-infrastructure.html',
    title:   'AI Is Not a Utility. But Its Infrastructure Should Be Regulated Like One.',
    excerpt: 'The debate over whether AI should be regulated as a public utility has produced more heat than light — because it treats AI as a single thing. AI is a stack. The legal question is not whether AI is intelligent. It is whether AI is infrastructural. And the answer depends entirely on which layer of the stack you are looking at.',
  },
  {
    id: 10,
